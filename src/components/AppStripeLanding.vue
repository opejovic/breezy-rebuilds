...
<div class="min-h-screen mx-auto relative overflow-x-hidden">
    ...
    <header class="mt-8 px-1">
      <nav class="flex justify-between items-center text-white">
        ...
        <div class="flex space-x-2">
          <button class="px-6 pt-[3px] pb-[6px] bg-white text-white bg-opacity-10 rounded-full">Sign in</button>
        </div>
      </nav>
    </header>
    <main>
      <div class="grid grid-flow-col grid-cols-2">
        <!-- Left side -->
        <section class="px-1 mt-20">
          <div>
            <div class="relative bg-gray-900 bg-opacity-20 inline-block px-4 rounded-full text-sm text-white py-1 tracking-wide space-x-2" style="">
          ...
          <h1 class="text-8xl font-bold tracking-tight mt-20 z-[-10] relative">Payments infrastructure <br />for the internet</h1>

          <p class="w-11/12 mt-10 text-xl text-gray-600">Millions of companies of all sizes—from startups to Fortune 500s—use Stripe’s software and APIs to accept payments, <br />send payouts, and manage their businesses online.</p>

          <div class="mt-10" data-name="cta-buttons">
            <button class="px-6 pt-[3px] pb-[6px] py-1 bg-gray-800 rounded-full text-white">Start now</button>
            <button class="px-6 pt-[3px] pb-[6px] text-black">Contact Sales</button>
          </div>
        </section>
        <!-- End left side -->
        ...
        <section class="mt-28 relative">
          <div class="h-full ml-28">
            ...
            <div class="bg-gray-100 w-[272px] h-full rounded-[36px] shadow-2xl drop-shadow-2xl p-[8px]" >
              <!-- Phone -->
              ...
              <div class="bg-gray-50 w-full h-full rounded-[36px] px-[16px] py-[24px]">
                ...
                <div class="mt-6 text-center text-xs text-gray-800 font-medium">
                  Increment Magazine
                  <p class="text-gray-500">$14 per quarter</p>
                </div>
      ...
      <section class="grid grid-cols-4 gap-y-16 mt-28 justify-items-center pb-20">
  ...
  <canvas class="absolute h-[620px] w-screen bottom-0 -top-64 rotate-0 min-w-[1000px] -skew-y-12 bg-gradient-to-r from-purple-400 via-yellow-300 to-blue-500 opacity-30 z-[-9]"></canvas>
  <canvas class="absolute h-[620px] w-screen bottom-0 -top-64 rotate-0 min-w-[1000px] -skew-y-12 bg-gradient-to-r from-purple-400 via-pink-500 to-blue-500 opacity-80 z-[-11]"></canvas>
  <div class="container mx-auto max-w-7xl absolute grid grid-flow-col grid-cols-4 min-h-screen w-screen inset-0 z-[-12]">
    <div class="border-l border-r border-dashed border-gray-800 border-opacity-10"></div>
    <div class="border-r border-dashed border-gray-800 border-opacity-10"></div>
    <div class="border-r border-dashed border-gray-800 border-opacity-10"></div>
    <div class="border-r border-dashed border-gray-800 border-opacity-10"></div>
  </div>
</div>
